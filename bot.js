...
setInterval(() => {
  http.get(`http://leather-rare-voice.glitch.me/`);
}, 280000);
...
let BTO_OWNERS  = ['534808591731785779','534808591731785779' ]
client.login('Njc2MDkwNzIxMTQ0NTM3MDk4.XpZnwQ.VEDETVCgPqYJ4QyE1VpF_i5QueQ');